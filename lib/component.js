...
Component.prototype.clientBaseClass = function() {
    if (typeof this.constructor.__super__ !== "undefined") {
...
Component.prototype.render = function() {
    ...
    clientCode += ']},\n';
    clientCode += '"namespace":"NextJs.providers",';
    clientCode += '"enableBuffer":10,';
    clientCode += '});\n';
    clientCode += 'NextJs.classes.'+this.constructor.name+'.clientConfig=' + this.clientConfig.toString() + '\n';
    clientCode += 'NextJs.components.' + this.globalId() + '=new NextJs.classes.' + this.constructor.name + '(NextJs.classes.'+this.constructor.name+'.clientConfig());\n';
